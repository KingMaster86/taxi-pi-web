        ...
        <div class="mt-4 feedback-responsive mx-auto">
            <form method="post" class="background-grey p-3 p-sm-3 p-md-5 rounded-2" id="passenger-feedback-form">
                ...
                <div class="pt-3 w-100 d-md-flex align-items-center gap-2">
                    <button type="submit" class="btn bg-warning border-black w-100 mb-3">
                        Create Account
                    </button>

                    <!-- Skip Button -->
                    <button type="button" class="btn bg-secondary text-light w-100 mb-3">
                        Skip
                    </button>
                </div>
            </form>
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $storeFeedback = mysqli_query($con, "INSERT INTO `table_passenger_feedback` (short_subject, content_body, rating, reservation_id) VALUES ('$subjectOfFeedback', '$feedbackBody', $feedbackRating, $recievedID)");
    if ($storeFeedback) {
