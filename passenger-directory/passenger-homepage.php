    ...
    <header class="container-fluid background-black-color">
      <nav class="navbar navbar-expand-lg container py-3">
        <div class="container-fluid">
          <!-- Logo -->
          <a class="navbar-brand text-white fs-1 fw-bold" href="./index.html"
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
              <li class="nav-item">
                <a
                  class="nav-link text-white fs-5 rounded hover-effect me-4 px-3 fw-semibold"
                  href="../about-us.html"
                  >Profile</a
                >
              </li>
    ...
    <main>
      <div class="mx-auto p-2 p-md-5 bg-danger">
        <div class="card mx-auto" id="driver-profile-card">
          <img
            src="../assets/img/admin-clipart.jpg"
            class="card-img-top"
            alt="..."
          />
          ...
          <ul class="list-group list-group-flush card-height overflow-y-scroll">
            <li class="list-group-item fw-bold">
              Username:
              <span class="text-decoration-none fw-normal font-black"
                >mushkir_96</span
              >
            </li>
            <li
              class="list-group-item d-md-flex align-items-center gap-2 pl-2 pt-0 pb-0 pe-0"
            >
            ...
            <li class="list-group-item fw-bold">
              ...
              <a
                href="tel:0000"
                class="text-decoration-none fw-normal font-black"
                >0777195282</a
              >
            </li>
          ...
          <div class="card-body">
            <a href="./edit-profile.html" class="card-link text-decoration-none"
              >Edit
            </a>
          </div>
        </div>
